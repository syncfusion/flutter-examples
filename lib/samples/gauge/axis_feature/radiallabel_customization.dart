  ...
  return SfRadialGauge(
    axes: <RadialAxis>[
      RadialAxis(startAngle: 180, endAngle: 360,
        ...
        pointers: <GaugePointer>[NeedlePointer(value: 70,
          needleStartWidth: 1, needleEndWidth: 3, needleLength: 0.8,
            lengthUnit: GaugeSizeUnit.factor,
        ...
        axisLabelStyle: GaugeTextStyle(fontSize: 12, fontWeight: FontWeight.w500),
       axisLineStyle: AxisLineStyle(thickness: 3, color: const Color(0xFF00A8B5))
      ),
    ],
  );
}
