...
List<RadialBarSeries<_RadialData, String>> getRadialBarDefaultSeries(
  ...
  final List<_RadialData> chartData = <_RadialData>[
    _RadialData('John', 10, '100%', const Color.fromRGBO(248, 177, 149, 1.0)),
    _RadialData('Almaida', 11, '100%', const Color.fromRGBO(246, 114, 128, 1.0)),
    _RadialData('Doe', 12, '100%', const Color.fromRGBO(61, 205, 171, 1.0)),
    _RadialData('Tom', 13, '100%', const Color.fromRGBO(1, 174, 190, 1.0)),
  ];
