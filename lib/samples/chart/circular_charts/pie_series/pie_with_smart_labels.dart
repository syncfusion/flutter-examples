...
class PieSmartLabels extends StatefulWidget {
  const PieSmartLabels(this.sample, {Key key}) : super(key: key);
...
class _PieSmartLabelsState extends State<PieSmartLabels> {
  ...
  @override
  void didUpdateWidget(PieSmartLabels oldWidget) {
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          launch(
                              'https://github.com/syncfusion/flutter-examples/blob/master/lib/samples/chart/circular_charts/pie_series/pie_with_smart_labels.dart');
                        },
                      ),
                    ),
                  ),
    ...
    return ScopedModelDescendant<SampleListModel>(
        ...
        builder: (BuildContext context, _, SampleListModel model) {
          return Scaffold(
            ...
            child: Container(child: getSmartLabelPieChart(false)),
          ));
        });
  }
}
...
List<PieSeries<_PieData, String>> getPieSeries(bool isTileView) {
  final List<_PieData> chartData = <_PieData>[
    _PieData('Greenland', 2130800),
    _PieData('New\nGuinea', 785753),
    _PieData('Borneo', 743330),
    _PieData('Madagascar', 587713),
    _PieData('Baffin\nIsland', 507451),
    _PieData('Sumatra', 443066),
    _PieData('Honshu', 225800),
    _PieData('Victoria\nIsland', 217291),
  ];
