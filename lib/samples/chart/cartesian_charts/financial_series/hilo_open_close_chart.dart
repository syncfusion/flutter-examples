...
class HiloOpenCloseChart extends StatefulWidget {
  ...
  @override
  _HiloOpenCloseChartState createState() =>
      _HiloOpenCloseChartState(sample);
}
...
List<HiloOpenCloseSeries<ChartSampleData, DateTime>> getHiloOpenCloseSeries(
  ...
  final List<ChartSampleData> chartData = <ChartSampleData>[
    ...
    ChartSampleData(x:DateTime(2016,07,04), yValue2:95.39, yValue:96.89, y:94.37, yValue3:96.68),
    ChartSampleData(x:DateTime(2016,07,11), yValue2:96.75, yValue:99.3, y:96.73, yValue3:98.78),
    ChartSampleData(x:DateTime(2016,07,18), yValue2:98.7, yValue:101, y:98.31, yValue3:98.66),
    ChartSampleData(x:DateTime(2016,07,25), yValue2:98.25, yValue:104.55, y:96.42, yValue3:104.21),
    ChartSampleData(x:DateTime(2016,08,01), yValue2:104.41, yValue:107.65, y:104, yValue3:107.48),
    ChartSampleData(x:DateTime(2016,08,08), yValue2:107.52, yValue:108.94, y:107.16, yValue3:108.18),
    ChartSampleData(x:DateTime(2016,08,15), yValue2:108.14, yValue:110.23, y:108.08, yValue3:109.36),
    ChartSampleData(x:DateTime(2016,08,22), yValue2:108.86, yValue:109.32, y:106.31, yValue3:106.94),
    ChartSampleData(x:DateTime(2016,08,29), yValue2:106.62, yValue:108, y:105.5, yValue3:107.73),
    ChartSampleData(x:DateTime(2016,09,05), yValue2:107.9, yValue:108.76, y:103.13, yValue3:103.13),
    ChartSampleData(x:DateTime(2016,09,12), yValue2:102.65, yValue:116.13, y:102.53, yValue3:114.92),
    ChartSampleData(x:DateTime(2016,09,19), yValue2:115.19, yValue:116.18, y:111.55, yValue3:112.71),
    ChartSampleData(x:DateTime(2016,09,26), yValue2:111.64, yValue:114.64, y:111.55, yValue3:113.05),
    ChartSampleData(x:DateTime(2016,10,03), yValue2:112.71, yValue:114.56, y:112.28, yValue3:114.06),
    ChartSampleData(x:DateTime(2016,10,10), yValue2:115.02, yValue:118.69, y:114.72, yValue3:117.63),
    ChartSampleData(x:DateTime(2016,10,17), yValue2:117.33, yValue:118.21, y:113.8, yValue3:116.6),
    ChartSampleData(x:DateTime(2016,10,24), yValue2:117.1, yValue:118.36, y:113.31, yValue3:113.72),
    ChartSampleData(x:DateTime(2016,10,31), yValue2:113.65, yValue:114.23, y:108.11, yValue3:108.84),
    ChartSampleData(x:DateTime(2016,11,07), yValue2:110.08, yValue:111.72, y:105.83, yValue3:108.43),
    ChartSampleData(x:DateTime(2016,11,14), yValue2:107.71, yValue:110.54, y:104.08, yValue3:110.06),
    ChartSampleData(x:DateTime(2016,11,21), yValue2:110.12, yValue:112.42, y:110.01, yValue3:111.79),
    ChartSampleData(x:DateTime(2016,11,28), yValue2:111.43, yValue:112.465, y:108.85, yValue3:109.9),
    ChartSampleData(x:DateTime(2016,12,05), yValue2:110, yValue:114.7, y:108.25, yValue3:113.95),
    ChartSampleData(x:DateTime(2016,12,12), yValue2:113.29, yValue:116.73, y:112.49, yValue3:115.97),
    ChartSampleData(x:DateTime(2016,12,19), yValue2:115.8, yValue:117.5, y:115.59, yValue3:116.52),
    ChartSampleData(x:DateTime(2016,12,26), yValue2:116.52, yValue:118.0166, y:115.43, yValue3:115.82),
    ];
