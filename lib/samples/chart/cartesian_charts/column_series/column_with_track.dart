...
class ColumnTracker extends StatefulWidget {
  const ColumnTracker(this.sample, {Key key}) : super(key: key);
...
class _ColumnTrackerState extends State<ColumnTracker> {
  ...
  @override
  void didUpdateWidget(ColumnTracker oldWidget) {
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        onPressed: () {
                          launch(
                              'https://github.com/syncfusion/flutter-examples/blob/master/lib/samples/chart/cartesian_charts/column_series/column_with_track.dart');
                        },
                      ),
                    ),
                  ),
...
List<ColumnSeries<_ChartData, String>> getTracker(bool isTileView) {
  final List<_ChartData> chartData = <_ChartData>[
    _ChartData('Subject 1', 71),
    _ChartData('Subject 2', 84),
    _ChartData('Subject 3', 48),
    _ChartData('Subject 4', 80),
    _ChartData('Subject 5', 76),
  ];
