...
class _CartesianLegendOptionsState extends State<CartesianLegendOptions> {
  ...
  Widget build(BuildContext context) {
    return getScopedModel(null, sample, CartesianLegendWithOptionsFrontPanel(sample));
  }
}
...
SfCartesianChart getCartesianLegendOptionsChart(bool isTileView,
    ...
    dynamic toggleVisibility, SampleModel model]) {
  ...
  return SfCartesianChart(
    ...
    legend: Legend(
        ...
        overflowMode: isExistModel ?  model.properties['OverflowMode'] : _overflowMode,
        toggleSeriesVisibility: isExistModel ?  model.properties['ToggleVisibility'] : toggleVisibility),
