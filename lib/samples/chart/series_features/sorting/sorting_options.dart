...
List<BarSeries<ChartSampleData, String>> getDefaultSortingSeries(
    bool isTileView,
    [String _sortby,
    SortingOrder _sortingOrder, SampleModel model]) {
  ...
  return <BarSeries<ChartSampleData, String>>[
    BarSeries<ChartSampleData, String>(
      ...
      sortingOrder: isExistModel
            ? model.properties['SortingOrder'] != null ? model.properties['SortingOrder'] : SortingOrder.none
...
class _SortingFrontPanelState extends State<SortingFrontPanel> {
  ...
  Widget sampleWidget(SampleModel model) => getDefaultSortingChart(false, null, null, model);
          ...
          return Scaffold(
            backgroundColor: model.cardThemeColor,
              ...
              Padding(
                ...
                child: Container(
                    child:
                        getDefaultSortingChart(false, _sortby, _sortingOrder, null)),
              ) : 
              Padding(
