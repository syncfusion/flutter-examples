...
class _DefaultPanningState extends SampleViewState {
  ...
  SfCartesianChart getDefaultPanningChart() {
  ...
  /// Returns the list of chart series which need to render on the chart with pinch zooming.
  ...
  void onZoomTypeChange(String item) {
