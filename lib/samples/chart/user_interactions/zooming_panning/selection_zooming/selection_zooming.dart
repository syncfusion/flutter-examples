...
class SelectionZoomingFrontPanel extends StatefulWidget {
  ...
  @override
  _SelectionZoomingFrontPanelState createState() =>
      _SelectionZoomingFrontPanelState(sample);
}

class _SelectionZoomingFrontPanelState
    extends State<SelectionZoomingFrontPanel> {
