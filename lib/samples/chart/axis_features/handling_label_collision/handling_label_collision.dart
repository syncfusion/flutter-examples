...
class _LabelActionState extends SampleViewState {
  ...
  Widget build(BuildContext context) {
    return getLabelIntersectActionChart();
  }
  ...
  SfCartesianChart getLabelIntersectActionChart() {
    return SfCartesianChart(
      ...
      series: getLabelIntersectActionSeries(),
  ...
  /// Method for updating the axis label intersect action type in the chart on change.
