...
SfCartesianChart getDefaultRSIIndicator(bool isTileView,[int _period, double _overBought, double _overSold, bool _showZones]) {
...
class _RSIIndicatorFrontPanelState
    extends State<RSIIndicatorFrontPanel> {
