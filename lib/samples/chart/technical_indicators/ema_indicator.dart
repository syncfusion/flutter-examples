...
class EMAIndicator extends StatefulWidget {
  EMAIndicator({this.sample, Key key}) : super(key: key);
  SubItem sample;

  @override
  _EMAIndicatorState createState() => _EMAIndicatorState(sample);
}

class _EMAIndicatorState extends State<EMAIndicator> {
  _EMAIndicatorState(this.sample);
