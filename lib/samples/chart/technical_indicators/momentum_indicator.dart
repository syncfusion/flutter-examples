...
class MomentummIndicator extends StatefulWidget {
  MomentummIndicator({this.sample, Key key}) : super(key: key);
  SubItem sample;

  @override
  _MomentummIndicatorState createState() => _MomentummIndicatorState(sample);
}

class _MomentummIndicatorState extends State<MomentummIndicator> {
  _MomentummIndicatorState(this.sample);
  final SubItem sample;
  @override
  Widget build(BuildContext context) {
    return getScopedModel(null, sample, MomentummIndicatorFrontPanel(sample));
  }
}
...
class _MomentummIndicatorFrontPanelState
    extends State<MomentummIndicatorFrontPanel> {
