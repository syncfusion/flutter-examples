...
class StochasticcIndicator extends StatefulWidget {
  StochasticcIndicator({this.sample, Key key}) : super(key: key);
  SubItem sample;

  @override
  _StochasticcIndicatorState createState() =>
      _StochasticcIndicatorState(sample);
}

class _StochasticcIndicatorState extends State<StochasticcIndicator> {
  _StochasticcIndicatorState(this.sample);
  final SubItem sample;
  @override
  Widget build(BuildContext context) {
    return getScopedModel(null, sample, StochasticcIndicatorFrontPanel(sample));
  }
}
...
class _StochasticcIndicatorFrontPanelState
    extends State<StochasticcIndicatorFrontPanel> {
  _StochasticcIndicatorFrontPanelState(this.sample);
  final SubItem sample;
  double _period = 14.0;
  double _kPeriod = 3.0;
  double _dPeriod = 5.0;
