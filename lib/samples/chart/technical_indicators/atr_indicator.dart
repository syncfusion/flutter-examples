...
class ATRIndicator extends StatefulWidget {
  ATRIndicator({this.sample, Key key}) : super(key: key);
  SubItem sample;

  @override
  _ATRIndicatorState createState() => _ATRIndicatorState(sample);
}

class _ATRIndicatorState extends State<ATRIndicator> {
  _ATRIndicatorState(this.sample);
  final SubItem sample;
  @override
  Widget build(BuildContext context) {
    return getScopedModel(null, sample, AtrIndicatorFrontPanel(sample));
  }
}

SfCartesianChart getDefaultATRIndicator(bool isTileView,
  ...
  return SfCartesianChart(
    ...
    indicators: <TechnicalIndicators<ChartSampleData, dynamic>>[
      AtrIndicator<ChartSampleData, dynamic>(
        seriesName: 'AAPL',
        yAxisName: 'yaxes',
        period: (isExistModel ? model.properties['AtrPeriod'] : _period) ?? 14
      ),
    ],
...
class _AtrIndicatorFrontPanelState extends State<AtrIndicatorFrontPanel> {
  ...
  Widget sampleWidget(SampleModel model) =>
      getDefaultATRIndicator(false, null, model);
  ...
  void initProperties([SampleModel sampleModel, bool init]) {
    ...
    if (sampleModel != null && init) {
      sampleModel.properties.addAll(<dynamic, dynamic>{'AtrPeriod': _period});
    }
  }
        ...
        return Scaffold(
            ...
            body: !model.isWeb
                ? Padding(
                    ...
                    child: Container(
                        child: getDefaultATRIndicator(false, _period.toInt())),
                  )
                : Padding(
                    padding: const EdgeInsets.fromLTRB(5, 0, 5, 0),
                    child: Container(
                        child: getDefaultATRIndicator(false, null, model)),
                  ),
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: CustomButton(
                          minValue: 0,
                          maxValue: 50,
                          initialValue: model.properties['AtrPeriod'],
                          onChanged: (dynamic val) => setState(() {
                            model.properties['AtrPeriod'] = val;
