...
SfCartesianChart getTrendLineDefaultChart(bool isTileView,
    [TrendlineType trendlineType, int polynomialOrder, int period]) {
  return SfCartesianChart(
    plotAreaBorderWidth: 0,
    title: ChartTitle(
        text: isTileView ? '' : 'No. of website visitors in a week'),
    ...
    series: getTrendLineDefaultSeries(
        isTileView, trendlineType, polynomialOrder, period),
...
class TrendLineDefaultWithOptionsFrontPanel extends StatefulWidget {
  ...
  TrendLineDefaultWithOptionsFrontPanel(this.subItemList);
  final SubItem subItemList;

  @override
  _TrendLineDefaultWithOptionsFrontPanelState createState() =>
      _TrendLineDefaultWithOptionsFrontPanelState(subItemList);
}
        ...
        return Scaffold(
          ...
          body: Padding(
            ...
            child: getTrendLineDefaultChart(
                false, _type, _polynomialOrder, _period),
          ),
                              ...
                              Padding(
                                ...
                                child: ListView(
                                  children: <Widget>[
                                    ...
                                    Visibility(
                                      visible:
                                          _selectedTrendLineType != 'Polynomial'
                                              ? false
                                              : true,
                                      maintainState: true,
                                      child: Container(
