...
class AxisTypes extends StatefulWidget {
  const AxisTypes({Key key}) : super(key: key);

  @override
  _AxisTypesState createState() => _AxisTypesState();
}

class _AxisTypesState extends State<AxisTypes> {
  @override
  void initState() {
    super.initState();
  }
