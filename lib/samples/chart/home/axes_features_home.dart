...
class AxesFeatures extends StatefulWidget {
  const AxesFeatures({Key key}) : super(key: key);

  @override
  _SeriesFeaturesState createState() => _SeriesFeaturesState();
}

class _SeriesFeaturesState extends State<AxesFeatures> {
  @override
  void initState() {
    super.initState();
  }
          ...
          children: <Widget>[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: str == 'N'
                    ? Colors.green
                    : str == 'U' ? Colors.yellow : Colors.transparent,
