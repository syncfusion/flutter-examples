...
class _RangeSelectorZoomingPageState extends State<RangeSelectorZoomingPage>
  ...
  SfCartesianChart columnChart, scatterChart;
  DateTime dateTimeMin = DateTime(2017, 01, 01);
  DateTime dateTimeMax = DateTime(2018, 01, 01);
  final SfRangeValues _dateTimeValues = SfRangeValues(
      DateTime.fromMillisecondsSinceEpoch(1483315200000),
      DateTime.fromMillisecondsSinceEpoch(1514505600000).add(const Duration(days: 2)));
  RangeController _dateTimeController;
  final List<ChartData> data = <ChartData>[];
  List<ChartData> columnData = <ChartData>[
    ChartData(DateTime(2000, 01, 01, 0), 100),
    ChartData(DateTime(2000, 01, 15), 10),
    ChartData(DateTime(2000, 02, 01), 40),
    ChartData(DateTime(2000, 02, 15), 34),
    ChartData(DateTime(2000, 03, 01), 80),
    ChartData(DateTime(2000, 03, 15), 49),
    ChartData(DateTime(2000, 04, 01), 56),
    ChartData(DateTime(2000, 04, 15), 26),
    ChartData(DateTime(2000, 05, 01), 8),
    ChartData(DateTime(2000, 05, 15), 80),
    ChartData(DateTime(2000, 06, 01), 42),
    ChartData(DateTime(2000, 06, 15), 12),
    ChartData(DateTime(2000, 07, 01), 28),
    ChartData(DateTime(2000, 07, 15), 68),
    ChartData(DateTime(2000, 08, 01), 94),
    ChartData(DateTime(2000, 08, 15), 24),
    ChartData(DateTime(2000, 09, 01), 72),
    ChartData(DateTime(2000, 09, 15), 32),
    ChartData(DateTime(2000, 10, 01), 48),
    ChartData(DateTime(2000, 10, 15), 4),
    ChartData(DateTime(2000, 11, 01), 64),
    ChartData(DateTime(2000, 11, 15), 10),
    ChartData(DateTime(2000, 12, 01), 85),
    ChartData(DateTime(2000, 12, 15), 96),
  ];

  List<Data> dateData = <Data>[
    ...
    Data(x: DateTime.fromMillisecondsSinceEpoch(1514505600000).add(const Duration(days: 2)), y: 0.8324)
  ];
  ...
  void initState() {
    ...
    for (int i = 0; i < 366; i++) {
      data.add(ChartData(DateTime(2000, 01, 01).add(Duration(days: i)),
          Random().nextInt(190) + 50));
    }
    columnChart = SfCartesianChart(
      margin: const EdgeInsets.all(0),
      primaryXAxis: DateTimeAxis(isVisible: false, maximum: DateTime(2018, 1, 1)),
...
class CustomThumbUp extends SfThumbShape {
  @override
  void paint(PaintingContext context, Offset center,
      {bool isEnabled,
      RenderProxyBox parentBox,
