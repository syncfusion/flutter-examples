...
List<ChatMessage> chatGettingStartedData({bool customTime = false}) {
  return <ChatMessage>[
    ChatMessage(
      text: 'Hey everyone, I attended a seminar on RenderBox and using '
    ...
    ChatMessage(
      text: "I had also signed up for the seminar but couldn't attend "
    ...
    ChatMessage(
      text: 'Carrie and I attended. The seminar was really informative, '
    ...
    ChatMessage(
      text: 'I’m currently working on a custom button using RenderBox, '
    ...
    ChatMessage(
      text: 'It’s pretty simple! Just initialize the recognizer in the '
    ...
    ChatMessage(
      text: 'Cristina, don’t forget the hitTestSelf method to ensure '
    ...
    ChatMessage(
      text: 'I always thought handling recognizers was complicated. Is it '
          'really that easy?',
      time: customTime
    ...
    ChatMessage(
      text: 'Yes! After the seminar, I realized how straightforward custom '
    ...
    ChatMessage(
      text: 'Building custom components with Flutter’s open-source tools '
    ...
    ChatMessage(
      text: 'I just looked into it, and Flutter seems to have a really '
    ...
    ChatMessage(
      text: ' What do you all think about teaming up to create something '
    ...
    ChatMessage(
      text: 'I have an idea! We could build a bot app for our college that '
    ...
    ChatMessage(
      text: 'This is the best idea I’ve heard! If we pull this off, '
    ...
    ChatMessage(
      text: 'Thanks, everyone! This Flutter app is going to be amazing. '
    ...
    ChatMessage(
      text: 'I’ll work on a basic UI design and share it with everyone '
...
List<ChatMessageExt> chatCustomizationData({bool customTime = false}) {
  return <ChatMessageExt>[
    ChatMessageExt(
      text: 'Hey Felipe, I watched a video about Flutter, and it made '
    ...
    ChatMessageExt(
      text: 'I’ve decided to start learning Flutter. Can you guide me '
    ...
    ChatMessageExt(
      text: 'Hi Jonathan, I’d be happy to help. First, download the Dart '
    ...
    ChatMessageExt(
      text: 'In that case, download Visual Studio Code 2024 first, '
    ...
    ChatMessageExt(
      text: "I've downloaded both Visual Studio Code and Flutter. "
    ...
    ChatMessageExt(
      text: 'Great! Now you need to install extensions in Visual Studio Code. '
    ...
    ChatMessageExt(
      text: 'Then follow this sequence: go to View -> Command Palette -> '
    ...
    ChatMessageExt(
      text: 'Awesome! You can run the sample project by entering the flutter '
    ...
    ChatMessageExt(
      text: 'Wow, the UI looks amazing, and the code is really '
          'easy to understand.',
      time: customTime
          ? DateTime.now().subtract(const Duration(minutes: 29))
          : DateTime.now(),
    ...
    ChatMessageExt(
      text: 'That’s the beauty of Flutter. It’s user-friendly and delivers '
    ...
    ChatMessageExt(
      text: 'I’m really enjoying building apps with Flutter. Everything '
    ...
    ChatMessageExt(
      text: 'Exactly! With Flutter, you’ll be building apps like a '
          'pro in no time.',
      time: customTime
          ? DateTime.now().subtract(const Duration(minutes: 24))
          : DateTime.now(),
    ...
    ChatMessageExt(
      text: 'No problem at all, I’m always here to help! By the way, '
    ...
    ChatMessageExt(
      text: ' Sounds good, and you can teach me more about '
