...
/// Renders anamoly detection data grid
class AnamolyDetectionSample extends SampleView {
  /// Creates  anamoly detection data grid
  const AnamolyDetectionSample({Key? key}) : super(key: key);

  @override
  _AnamolyDetectionSampleState createState() => _AnamolyDetectionSampleState();
}

class _AnamolyDetectionSampleState extends SampleViewState
