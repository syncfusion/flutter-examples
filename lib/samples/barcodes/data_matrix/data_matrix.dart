        ...
        builder: (BuildContext context, _, SampleModel model) {
          ...
          return Scaffold(
              ...
              body: Padding(
                ...
                child: Container(
                    child: getDataMatrixGenerator(_inputValue,
                        _padding,
                        kIsWeb ? MediaQuery
                            .of(context)
                            .size
...
Widget getDataMatrixGenerator([String _inputValue, EdgeInsets _padding, double height, SampleModel model]) {
  ...
  return Center(
    child:  Container(
        ...
        child: Padding(
          ...
          model.properties['InputValue'] ?? 'http://www.syncfusion.com' : _inputValue
              ?? 'http://www.syncfusion.com',
            textAlign: TextAlign.justify,
            textSpacing: 10,
            showValue: false, symbology: DataMatrix(encoding: DataMatrixEncoding.base256),),
        )
    ),
  );
