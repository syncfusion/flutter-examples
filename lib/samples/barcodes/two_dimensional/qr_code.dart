...
class _QRCodeGeneratorState extends State<QRCodeGenerator> {
        ...
        builder: (BuildContext context, _, SampleModel model) {
          return Scaffold(
              ...
              body: Padding(
                ...
                child: Container(
                    child: getQRCodeGenerator(_inputValue,
                        _errorCorrectionLevel, _inputMode, _padding,
                        kIsWeb ? MediaQuery
                            .of(context)
                            .size
                            .height * 0.4 : null,model)),
              ),
                            ...
                            child: Theme(
                              ...
                              child: TextField(
                                  ...
                                  onChanged: (String _text) {
                                      model.properties['InputValue'] = _inputValue = _text;
                                      if(model.isWeb){
                          ...
                          child: Align(
                            ...
                            child: Theme(
                              data: Theme.of(context).copyWith(
                                  canvasColor: model.bottomSheetBackgroundColor),
                              child: DropDown(
                                  value: model.properties['SelectedErrorCorrectionLevel'],
  ...
  void _onErrorCorrectionLevelChanged(String item, SampleModel model) {
    ...
    model.properties['SelectedErrorCorrectionLevel'] = _selectedErrorCorrectionLevel;
...
Widget getQRCodeGenerator([String _inputValue,
ErrorCorrectionLevel _correctionLevel, QRInputMode _inputMode,  EdgeInsets _padding, double height,SampleModel model]) {
  ...
  return Center(
    child:  Container(
        ...
        child: Padding(
          ...
          child: SfBarcodeGenerator(value: isExistModel ?
          model.properties['InputValue']??  'http://www.syncfusion.com'  :
          _inputValue ?? 'http://www.syncfusion.com',
            textAlign: TextAlign.justify,
            textSpacing: 10,
            showValue: false, symbology: QRCode(
                inputMode:isExistModel ? model.properties['InputMode'] :
                _inputMode ?? QRInputMode.binary,
                codeVersion: QRCodeVersion.auto,
                errorCorrectionLevel:
                isExistModel ? model.properties['ErrorCorrectionLevel'] :
