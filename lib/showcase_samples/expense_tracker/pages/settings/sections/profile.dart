...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    ...
    _originalDate =
        widget.userProfile.dateOfBirth != null
    ...
    return Column(
      ...
      children: [
        Flexible(
          child: SizedBox(
            width:
                isMobile(context) ? MediaQuery.of(context).size.width : 620.0,
            child: Column(
              // mainAxisSize: MainAxisSize.min,
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color:
                        _isChanged ? _colorScheme.primary : Colors.transparent,
                    border: Border.all(
                      color:
                          _isChanged
                              ? Colors.transparent
                  ...
                  child: Padding(
                    ...
                    child: TextButton(
                      ...
                      child: Text(
                        ...
                        style: _textTheme.titleSmall?.copyWith(
                          color:
                              _isChanged ? _colorScheme.onPrimary : Colors.grey,
                        ),
                      ),
                    ),
                  ),
